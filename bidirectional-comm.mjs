...
(function(R, c) {
  (function(h, p) {
    ...
    var h = {}, p = { exports: h }, b = Object.defineProperty, C = Object.defineProperties, O = Object.getOwnPropertyDescriptor, P = Object.getOwnPropertyDescriptors, D = Object.getOwnPropertyNames, Q = Object.getOwnPropertySymbols, Y = Object.prototype.hasOwnProperty, ie = Object.prototype.propertyIsEnumerable, re = (e, t, n) => t in e ? b(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, F = (e, t) => {
      ...
      return e;
    }, ri = (e) => ii(b({}, "__esModule", { value: !0 }), e), on = {};
    rn(on, {
      ErrorInfo: () => m,
      Realtime: () => Dt,
      Rest: () => kt,
      default: () => Vo,
      msgpack: () => Yt,
      protocolMessageFromDeserialized: () => Sr
    }), p.exports = ri(on);
    var y = class {
    ...
    function Oi(e, t, n) {
      ...
      const a = e.restHost || (r ? j.REST_HOST : i + "-" + j.REST_HOST), l = Ri(e, r, i, s);
    ...
    function Wn(e) {
      return e.useTokenAuth || !_i(e) && (e.authCallback || e.authUrl || e.token || e.tokenDetails);
    }
    function Gi(e) {
    ...
    var Li = class {
      ...
      async authorize(e, t) {
        ...
        try {
          ...
          return Ei(this.client) ? new Promise((s, i) => {
      ...
      async createTokenRequest(e, t) {
        ...
        const f = a.nonce || (a.nonce = ki()), g = a.timestamp, w = a.keyName + `
` + d + `
` + u + `
` + l + `
` + g + `
` + f + `
`;
        return a.mac = a.mac || Pi(w, r), o.logAction(this.logger, o.LOG_MINOR, "Auth.getTokenRequest()", "generated signed request"), a;
      }
      /**
      ...
      async _ensureValidAuthCredentials(e) {
        ...
        if (this.currentTokenRequestId !== null && !e)
          return n;
        const s = this.currentTokenRequestId = Ni();
        let i, r = null;
        try {
    ...
    var Tt = class {
      ...
      async doUri(e, t, n, s, i) {
        try {
          Hi(e, t, s, i, this.logger);
          const r = await this.platformHttp.doUri(e, t, n, s, i);
          return this.logger.shouldLog(o.LOG_MICRO) && Ui(r, e, t, i, this.logger), r;
        } catch (r) {
    ...
    var Zi = class _e {
      ...
      static async do(t, n, s, i, r, a, l, d) {
        ...
        if (l && (g = Di(g, n._MsgPack, l)), u.shouldLog(o.LOG_MICRO) && Wi(g, t, s, a, u), d) {
          if (g.err)
            throw g.err;
          {
            const w = F({}, g);
    ...
    var Ji = class {
      ...
      async handlePage(e) {
        if (e.err && Vi(e.err, e.body, this.useHttpPaginatedResponse))
          throw o.logAction(
            this.logger,
            o.LOG_ERROR,
        ...
        return e.headers && (n = e.headers.Link || e.headers.link) && (s = ji(n)), this.useHttpPaginatedResponse ? new Fi(
          this,
          t,
          e.headers || {},
          e.statusCode,
    ...
    var Xi = Jn, Ot = Xi, Yi = class {
      ...
      constructor(e) {
        this.client = e, this.deviceRegistrations = new Qi(e), this.channelSubscriptions = new Ki(e);
      }
      async publish(e, t) {
      ...
      constructor(t) {
        this.remove = js.prototype.removeWhere, this.client = t;
      }
      async save(t) {
    ...
    async function vt(e, t) {
      ...
      return t != null && t.cipher ? ir(e, t) : e;
    }
    ...
    var gr = class {
      constructor(e, t, n) {
        var s, i;
        o.logAction(e.logger, o.LOG_MINOR, "RestChannel()", "started; name = " + t), this.name = t, this.client = e, this.presence = new ur(this), this.channelOptions = tt((s = e._Crypto) != null ? s : null, this.logger, n), (i = e.options.plugins) != null && i.Push && (this._push = new e.options.plugins.Push.PushChannel(this));
      }
      get push() {
      ...
      async publish(...e) {
        ...
        await this._publish(rr(s, r._MsgPack, l), u, i);
      }
      ...
      constructor(e) {
        this.channelMixin = ns, this.presenceMixin = br, this.Resource = W, this.DeviceDetails = Ce, this.client = e, this.channels = new Ir(this.client), this.push = new $i(this.client);
      }
      async stats(e) {
      ...
      get(e, t) {
        e = String(e);
        let n = this.all[e];
        return n ? t && n.setOptions(t) : this.all[e] = n = new pr(this.client, e, t), n;
      }
      ...
      static async fromEncodedArray(e, t) {
        return sr(o.defaultLogger, y.Crypto, e, t);
      }
      // Used by tests
      static fromValues(e) {
      ...
      static async fromEncodedArray(e, t) {
        return cr(o.defaultLogger, e, t);
      }
      static fromValues(e, t) {
        return se(e, t);
      }
    }, Se = class at extends Rr {
    ...
    function _t(e, t) {
      ...
      if (e.messages && (n += "; messages=" + cs(Ct(e.messages))), e.presence && t && (n += "; presence=" + cs(t.presenceMessagesFromValuesArray(e.presence))), e.error && (n += "; error=" + m.fromValues(e.error).toString()), e.auth && e.auth.accessToken && (n += "; token=" + e.auth.accessToken), e.flags && (n += "; flags=" + Or.filter(e.hasFlag).join(",")), e.params) {
        let r = "";
    ...
    var Ie = Pr, Gr = ae({ action: E.CLOSE }), Br = ae({ action: E.DISCONNECT }), Nr = class extends V {
      ...
      requestClose() {
        o.logAction(this.logger, o.LOG_MINOR, "Transport.requestClose()", ""), this.send(Gr);
      }
      requestDisconnect() {
        o.logAction(this.logger, o.LOG_MINOR, "Transport.requestDisconnect()", ""), this.send(Br);
      }
      ping(e) {
    ...
    var Lr = typeof pe < "u" ? pe : typeof window < "u" ? window : self, Bt = () => {
      var e;
    ...
    var Hr = class {
      ...
      initTransports() {
        Js.initTransports(this.realtime._additionalTransportImplementations, this);
      }
      createTransportParams(t, n) {
        return new Hr(this.options, t, n, this.connectionKey);
      }
        ...
        o.logAction(this.logger, o.LOG_MICRO, "ConnectionManager.tryATransport()", "trying " + n), this.proposedTransport = Me.tryConnect(
          ...
          (i, r) => {
            ...
            if (i) {
              ...
              })) : i.event === "failed" ? (this.notifyState({ state: "failed", error: i.error }), s(!0)) : i.event === "disconnected" && (_r(i.error) ? s(!1) : (this.notifyState({ state: this.states.connecting.failState, error: i.error }), s(!0)));
              return;
            }
            o.logAction(
              this.logger,
      ...
      activateTransport(t, n, s, i) {
        ...
        this.activeProtocol = new kr(n), this.host = n.params.host;
      ...
      queue(t, n) {
        ...
        s && !s.sendAttempted && Ur(s.message, t, i) ? (s.merged || (s.callback = It.create(this.logger, [s.callback]), s.merged = !0), s.callback.push(n)) : this.queuedMessages.push(new ds(t, n));
      }
      sendQueuedMessages() {
        o.logAction(
          this.logger,
    ...
    var jr = class tn extends V {
      ...
      async setOptions(t) {
        var n;
        const s = this.channelOptions, i = zr(t);
        if (i)
          throw i;
    ...
    var Ht = jr, ys = class Fs extends zn {
      /*
       * The public typings declare that this only accepts an object, but since we want to emit a good error message in the case where a non-TypeScript user does one of these things:
       *
       * 1. passes a string (which is quite likely if they’re e.g. migrating from the default variant to the modular variant)
      ...
      constructor(t) {
        ...
        this._additionalTransportImplementations = Fs.transportImplementationsFromPlugins(this.options.plugins), this._RealtimePresence = (s = (n = this.options.plugins) == null ? void 0 : n.RealtimePresence) != null ? s : null, this.connection = new Wr(this, this.options), this._channels = new Jr(this), this.options.autoConnect !== !1 && this.connect();
      }
    ...
    var qr = class extends V {
      ...
      async _enterOrUpdateClient(e, t, n, s) {
        ...
        o.logAction(
          ...
          "channel = " + i.name + ", id = " + e + ", client = " + (t || "(implicit) " + Xr(this))
        );
        const r = ts(n);
    ...
    }, Qr = qr, Kr = q.WebSocket;
    function $r(e) {
      return !!e.on;
    }
    var eo = class extends Me {
      constructor(e, t, n) {
        super(e, t, n), this.shortName = Kr, n.heartbeats = y.Config.useProtocolHeartbeats, this.wsHost = n.host;
      }
      static isAvailable() {
    ...
    var zt, rt, no = !!new Wt(new He([1]).buffer)[0];
    function jt(e) {
      return no ? (
        // byte 1 -> byte 4
        e >>> 24 | // byte 2 -> byte 3
    ...
    var io = class {
      ...
      hmacSha256(e, t) {
        const n = so(this.toBuffer(t), this.toBuffer(e));
        return this.toArrayBuffer(n);
      }
    }, vs = new io(), ro = function(e, t) {
    ...
    var Ze, Ms = (Ze = class {
      constructor(e) {
        ...
        y.Config.xhrSupported && a ? (this.supportsAuthHeaders = !0, this.Request = async function(u, f, g, w, I) {
          ...
          let g = !1;
          return i ? g = !f.error && ((u = f.body) == null ? void 0 : u.replace(/\n/, "")) == "yes" : g = !f.error && Ai(f.statusCode), o.logAction(this.logger, o.LOG_MICRO, "(XHRRequest)Http.checkConnectivity()", "Result: " + g), g;
    ...
    }, Ze.methods = [H.Get, H.Delete, H.Post, H.Put, H.Patch], Ze.methodsWithoutBody = [H.Get, H.Delete], Ze.methodsWithBody = [H.Post, H.Put, H.Patch], Ze), As = Ms, Ae = "ablyjs-storage-test", ke = typeof pe < "u" ? pe : typeof window < "u" ? window : self, oo = class {
      constructor() {
        try {
    ...
    }, ks = new oo(), x = yt(), ao = typeof EdgeRuntime == "string";
    typeof Window > "u" && typeof WorkerGlobalScope > "u" && !ao && console.log(
    ...
    var ho = x.navigator && x.navigator.userAgent.toString(), uo = x.location && x.location.href, fo = {
      agent: "browser",
      logTimestamps: !0,
      userAgent: ho,
      currentUrl: uo,
    ...
    function Jt(e) {
      return go(e) ? [ae({ action: E.ERROR, error: e })] : [ae({ action: E.DISCONNECTED, error: e })];
    }
...
`), n = {};
    ...
    var vo = class Xs extends V {
      constructor(t, n, s, i, r, a, l, d) {
        super(l), s = s || {}, s.rnd = gt(), this.uri = t + Ne(s), this.headers = n || {}, this.body = i, this.method = d ? d.toUpperCase() : te(i) ? "GET" : "POST", this.requestMode = r, this.timeouts = a, this.timedOut = !1, this.requestComplete = !1, this.id = String(++Ro), Ps[this.id] = this;
      }
      ...
      exec() {
        ...
        const v = () => {
          ...
          f = this.requestMode == ge.REQ_RECV_STREAM && w && To(r);
        }, M = () => {
          let A;
          try {
            const J = wo(r, "content-type");
            if (J ? J.indexOf("application/json") >= 0 : r.responseType == "text") {
              ...
              A = r.response;
            A.response !== void 0 ? (g = A.statusCode, w = g < 400, t = A.headers, A = A.response) : t = Oo(r);
          } catch (J) {
...
`, I)) > -1; )
      ...
      dispose() {
        const t = this.xhr;
        if (t) {
          t.onreadystatechange = t.onerror = t.onabort = t.ontimeout = Io, this.xhr = null;
          const n = this.timer;
          n && (clearTimeout(n), this.timer = null), this.requestComplete || t.abort();
        }
        delete Ps[this.id];
      }
    }, _s = vo, Gs = q.XhrPolling, Co = class extends mo {
      constructor(e, t, n) {
      ...
      constructor(e, t) {
        this.map = (n) => {
          ...
          switch (n) {
            ...
            case 211:
              return s = Bo(this.view, this.offset + 1), this.offset += 9, s;
            case 212:
    ...
    function xo(e) {
      const t = new DataView(e), n = new Ho(t), s = n.parse();
      ...
      if (typeof e == "number") {
        ...
        if (e >= 0) {
          ...
          if (e < 18446744073709552e3)
            return t.setUint8(n, 207), Uo(t, n + 1, e), 9;
        ...
        if (e >= -9223372036854776e3)
          return t.setUint8(n, 211), Lo(t, n + 1, e), 9;
    ...
    async function zo(e, t, n, s, i, r) {
      ...
      const w = (async () => {
        try {
          ...
          return I.ok ? { error: null, body: v, headers: B, unpacked: M, statusCode: I.status } : { error: Wo(v, I.headers) || new z(
    ...
    y.Crypto = Us, y.BufferUtils = vs, y.Http = As, y.Config = Es, y.Transports = ko, y.WebStorage = ks;
    for (const e of [kt, Dt])
      e.Crypto = Us, e._MsgPack = Yt;
    As.bundledRequestImplementations = jo, o.initLogHandlers(), y.Defaults = Si(Po), y.Config.agent && (y.Defaults.agent += " " + y.Config.agent);
    var Vo = {
      ErrorInfo: m,
      Rest: kt,
      Realtime: Dt,
    ...
    if (typeof p.exports == "object" && typeof h == "object") {
      ...
      p.exports = Jo(p.exports, h);
    }
    return p.exports;
  });
})(Zs);
var ia = Zs.exports;
const Qt = /* @__PURE__ */ qe(ia);
...
var Ys = Number.isNaN || function(c) {
  return c !== c;
};
function G() {
  G.init.call(this);
...
G.prototype.emit = function(c) {
  ...
  if (typeof D == "function")
    ...
    for (var Q = D.length, Y = ti(D, Q), p = 0; p < Q; ++p)
      xs(Y[p], this, h);
  return !0;
};
function Qs(R, c, h, p) {
  ...
  if (ht(h), C = R._events, C === void 0 ? (C = R._events = /* @__PURE__ */ Object.create(null), R._eventsCount = 0) : (C.newListener !== void 0 && (R.emit(
    ...
    P.name = "MaxListenersExceededWarning", P.emitter = R, P.type = c, P.count = O.length, ra(P);
  }
  return R;
}
G.prototype.addListener = function(c, h) {
  return Qs(this, c, h, !1);
};
G.prototype.on = G.prototype.addListener;
G.prototype.prependListener = function(c, h) {
  return Qs(this, c, h, !0);
};
function oa() {
  if (!this.fired)
...
function Ks(R, c, h) {
  var p = { fired: !1, wrapFn: void 0, target: R, type: c, listener: h }, b = oa.bind(p);
  return b.listener = h, p.wrapFn = b, b;
}
G.prototype.once = function(c, h) {
  return ht(h), this.on(c, Ks(this, c, h)), this;
};
G.prototype.prependOnceListener = function(c, h) {
  return ht(h), this.prependListener(c, Ks(this, c, h)), this;
};
G.prototype.removeListener = function(c, h) {
  ...
  if (p === h || p.listener === h)
    ...
    if (C < 0)
      return this;
    C === 0 ? p.shift() : aa(p, C), p.length === 1 && (b[c] = p[0]), b.removeListener !== void 0 && this.emit("removeListener", c, P || h);
  }
  return this;
};
...
function $s(R, c, h) {
  ...
  if (p === void 0)
    return [];
  var b = p[c];
  return b === void 0 ? [] : typeof b == "function" ? h ? [b.listener || b] : [b] : h ? ca(b) : ti(b, b.length);
}
...
G.listenerCount = function(R, c) {
  return typeof R.listenerCount == "function" ? R.listenerCount(c) : ei.call(R, c);
};
G.prototype.listenerCount = ei;
function ei(R) {
  var c = this._events;
  if (c !== void 0) {
    var h = c[R];
...
function la(R, c) {
  return new Promise(function(h, p) {
    ...
    ni(R, c, C, { once: !0 }), c !== "error" && ha(R, b, { once: !0 });
  });
}
function ha(R, c, h) {
  typeof R.on == "function" && ni(R, "error", c, h);
}
function ni(R, c, h, p) {
...
var ua = sn.exports;
const da = /* @__PURE__ */ qe(ua), fa = (R) => new Promise((c, h) => setTimeout(() => {
  h(new Error("timeout"));
}, R));
class ga extends da {
  constructor() {
...
const pa = "https://script.google.com/macros/s/AKfycbx0Qp3f_lSKc15zHVBoR5UpcJQFxAcsoRsKU5DZA_7x-fOX2JksauUb8swJrsDKs0Qo3w/exec";
let _ = (R) => R.defaultMessage;
const ma = () => {
  _.setup({
    translations: na
  });
}, ot = "bidirectionalComm";
let Ws = "http://localhost:8080/dist/bidirectional-comm.mjs";
class lt {
  /**
  ...
  async fetchLicense(c) {
    try {
      const h = pa + "?id=" + c, b = await (await fetch(h)).json();
  ...
  async connect(c) {
    ...
    await this.server.connect(h), this.lastSystemMessage = {
  ...
  disconnect() {
    if (this.isEnabledPacketCapture = !1, !this.hasTrialLicense()) {
      this.setNoLicenseMessage();
      return;
    }
